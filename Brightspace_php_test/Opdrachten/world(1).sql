...
--
-- Machine: localhost
-- Genereertijd: 09 Dec 2009 om 10:53
-- Serverversie: 5.1.33
-- PHP-Versie: 5.2.9
...
--
-- Gegevens worden uitgevoerd voor tabel `countrylanguage`
--
...
ALTER TABLE `countrylanguage`
  ADD CONSTRAINT `countrylanguage_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`Code`) ON UPDATE CASCADE;
